...
public abstract class Database extends BeanFactory implements ExecutionContext {
     ...
     * übergebenen Bean-Package und nimmt als Modulnamen für den DB-Zugriff
     * das Modul des übergebenen Octopus-Kontexts. Der Kontext wird sich
     * weiterhin gemerkt, um Pfade zugehöriger Bean-Properties zu finden.
     * 
     ...
     * 
     * @param moduleName Modulnamen für den DB-Zugriff.
     * @param beanPackage Java-Package, in dem sich die Bean-Klassen
     *  befinden. 
     */
     ...
     * unabhängiger SQL-Statements benötigt, sollte aber nicht unnötig genutzt und erst
     ...
     * TODO: Die geholte Connection wird nicht geschlossen. Ändern! 
     * 
     ...
     * und füllt die übergebene Liste der Platzhalter-Felder.
     * 
	...
	void closeResultSet() {
		try {
            ...
            if (logger.isDebugEnabled())
                logger.debug("Fehler beim Schließen eines ResultSets", e);
		}
	}
