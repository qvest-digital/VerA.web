...
public static org.apache.commons.logging.LogFactory forTesting() {
    org.apache.commons.logging.LogFactory result = getLogFactory();
    getLog("Axis overrider from OCTOPUS core").debug(result);
    return result;
}

    @SuppressWarnings("unused")
    static Class class$org$apache$commons$logging$LogFactory = org.apache.commons.logging.LogFactory.class;
}
