...
public class CallableStatementProxyInvocationHandler extends PreparedStatementProxyInvocationHandler
{
	...
	private void fetchResultSet() throws Throwable
	{
		...
		{
			this.resultSet = ( ResultSet ) Proxy.newProxyInstance( this.getClass().getClassLoader(), new Class[] { ResultSet.class }, new ResultSetProxyInvocationHandler( this.statement.getResultSet() ) );
		}
	}
}
