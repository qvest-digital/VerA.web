...
\begin{tabu} to \linewidth {rl}
\rowfont\bfseries\multicolumn{2}{c}{Legende}\\
...
Vierte Spalte: & \tikz \node[thick,rectangle,draw=CornflowerBlue] {};
		 ...
		 \tikz \node[thick,rectangle,draw=black] {};
		 Skript (Installation/Upgrade)\\
 Schattierung: & \tikz \node[rectangle,fill=red!20] {}; OSIAM;
		 \tikz \node[rectangle,fill=yellow!40] {}; Online-Anmeldung;
		 \tikz \node[rectangle,fill=green!20] {}; VerA.web core;
		 \tikz \node[rectangle,fill=blue!20] {}; LDAP\\
\end{tabu}
