...
noch weiter anpassen. Die Nachfolgenden Abschnitte erläuter die Möglichkeiten
und beschreiben die Durchführung.
...
Mit dem Eintrag imprint.<language_key>.<sorting_number><space><titel>=<text>
...
einmal für den Sprachschlüssel (<language_key>) "de_DE" und "en_EN" existieren.

Aus den drei Teilen <sorting_number>, <space> und <titel> setzt sich die Überschrift
...
und dem Titel zu erzeugen muss das UTF-8 encoding \\u00a0 verwendet werden. Andere
Umlaute wie ä,ö,ü,Ä,Ö,Ü,ß,... müssen auch dementsprechend codiert werden.

Der eigentliche Text des Abschnitts (<text>) kann mit Leerzeichen umgehen. Umlaute
müssen aber weiterhin codiert werden.

Um nur einen Textblock ohne Überschrift zu generieren, kann <sorting_number>,
<space> und <titel> weggelassen werden. Der Eintrag muss dann wie folgt
gestaltet werden: imprint.de_DE.=<text> bzw. imprint.en_EN.=<text>.
