...
\newcommand{\myinlinepic}[2][\@empty]{%
 ...
 \savebox{\myinlinebox}{\ovalbox{\strut\hspace{1.5ex}}}%
 ...
 \ovalbox{%
  ...
  \strut%
  % move the graphic ⅓ \strut depth down (ca. 10% of \baselineskip)
  % due to raising picture size from 1¼ex to 1½ex breaking vertical centering
  \raisebox{-\depth/3}{%
   \strut%
   % the graphic
   \resizebox{!}{1.5ex}{\includegraphics{#2}}%
  }%
  % the text, if any
