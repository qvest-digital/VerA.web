...
% - Java 8
% - user/verz. vorgeben?
% - wo sind PWs hinterlegt? (Übersicht)
% - inet-Zugang/Download oSIAM
% TODO Team:
% - neuer Mail-Kram
% - Bug: Kategorie „Keine“ → Exception in GuestDetailWorker.setGuestCategory:392 parseInt(string "")
...
\begin{tabular}{| r || l | l | l |}\hline
 ...
 Applikationsserver    & Tomcat 7   & Tomcat 7            & Tomcat 7\Hair\textsuperscript{\ref{fn:req-nonewer}}\\\hline
\end{tabular}
...
ist, damit sie nicht versehentlich verwendet werden kann:
...
\texttt{/var/log/vwoa/vwoa.log}} und die Verfügbarkeit des Dienstes
...
für das Bild auf \inlinekasten{Kontaktfoto hochladen}. Wählen Sie die
Datei \texttt{testpic.jpg} aus dem „files“-Archiv
(\texttt{veraweb-core-\vwiaverssw{}-files.tgz} \emph{oder}
\texttt{veraweb-core-\vwiaverssw{}-files.zip}) und bestätigen Sie, dann
klicken Sie ganz unten rechts auf \inlinekasten{Speichern}.

%TODO Exception, weil im Registerreiter Allgemein unter Kategorie
% nur „Keine“ auswählbar ist und die knallt.
⚠ VerA.web Bug – WIP
...
und ein Kontaktfoto\Hair\footnote{wieder \texttt{testpic.jpg} aus dem
„files“-Archiv} eingeben und auf \inlinekasten{Speichern} klicken.
