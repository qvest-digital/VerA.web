...
\newcommand{\vwianame}{Gesamtanleitung VerA.web}
...
sudo install -c -o 0 -g tomcat7 -m 640 config_override.xml /etc/veraweb/
...
Datei\Hair\footnote{\label{fn:testpic}ein JPEG- oder PNG-Bild von exakt
186x245 Pixeln Größe} und bestätigen Sie, dann
