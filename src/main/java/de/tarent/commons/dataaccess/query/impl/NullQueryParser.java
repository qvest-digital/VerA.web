...
public class NullQueryParser extends AbstractQueryContext implements QueryParser {
	public NullQueryParser() {
		// just for open call hierarchy ;-)
	}

	public void parse(Object o) {
		if (o != null)
			throw new DataAccessException(
					"NullQueryParser expected null expr, but type " +
					o.getClass() + " found (" + o + ").");
	}
}
