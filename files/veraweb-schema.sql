...
BEGIN
	...
	IF vint = 0 THEN
		...
		veraweb, platform independent webservice-based event management (Veranstaltungsmanagment VerA.web), is Copyright © 2004–2008 tarent GmbH; Copyright © 2013–2015 tarent solutions GmbH
