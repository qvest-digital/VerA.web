...
BEGIN
	...
	IF vint = 0 THEN
		...
		veraweb, platform independent webservice-based event management (Veranstaltungsmanagment VerA.web), is Copyright © 2004–2008 tarent GmbH; Copyright © 2013–2016 tarent solutions GmbH
