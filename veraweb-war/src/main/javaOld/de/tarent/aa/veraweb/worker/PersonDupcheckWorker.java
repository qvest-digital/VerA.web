...
public class PersonDupcheckWorker extends ListWorkerVeraWeb {
	...
	protected Clause getDuplicateExprPerson(OctopusContext cntx, Person person) {
		...
		String ln = person == null || person.lastname_a_e1 == null || person.lastname_a_e1 == "" ? "" : person.lastname_a_e1;
		String fn = person == null || person.firstname_a_e1 == null || person.firstname_a_e1 == "" ? "" : person.firstname_a_e1;
