...
import de.tarent.aa.veraweb.cucumber.pagedefinitions.PageDefinition.ElementDefinition;
...
public abstract class AbstractStepDefinitions {
	...
	/**
	 * Default {@link DateTimeFormatter}.
	 */
	protected static final DateTimeFormatter DEFAULT_DATETIME_FORMATTER = DateTimeFormat.forPattern("dd.MM.yyyy");
	...
	protected void whenFillField(DateMidnight date, ElementDefinition elementDefinition) {
		whenFillField(date.toString(DEFAULT_DATETIME_FORMATTER), elementDefinition);
	}
