...
public class PersonExportWorker extends PersonListWorker {
	 ...
	 */
	protected void exportSelect(SpreadSheet spreadSheet, Database database, Grants grants, Select select, String memberAEx, String memberBEx, String addressEx) throws BeanException {
		try {
