...
# Die folgende Einstellung beeinflusst die Benutzeransicht.
# Der gesetzte Wert zeigt die Standardeinstellung.
# Die interne Id einer Person wird mit (in allen Uebersichtstabellen) angezeigt
