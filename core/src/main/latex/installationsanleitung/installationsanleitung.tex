...
den Registerreiter \inlinebild[Account types]{lam-gear} aus. Stellen Sie
sicher, daß unter „Active account types“ nur \inlinebild[Users]{lam-user}
...
in \texttt{ou=Group} gefolgt von einem Komma und Ihrem Base DN, also z.B:
\texttt{ou=Group,dc=lan,dc=tarent,dc=de}
...
\texttt{posixAccount} und \texttt{shadowAccount} (Users) bzw.
