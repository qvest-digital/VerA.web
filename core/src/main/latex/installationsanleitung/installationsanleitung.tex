...
\newcommand{\vwiaversfassungnr}{7.3}
...
Anmerkung: Debian 10 („buster“) wird mit OpenJDK 11 (nicht getestet)
und Tomcat 9 (ist \emph{nicht} kompatibel mit VerA.web) ausgeliefert
und wird daher aktuell von abgeraten.
...
\begin{itemize}
 ...
 \item{die in der Anwendung selbst oben rechts verlinkten
  \emph{Lizenzbestimmungen}, inklusive Quellkode der Anwendung
  und aller gebündelten Abhängigkeiten}
\end{itemize}
