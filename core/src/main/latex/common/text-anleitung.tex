...
\texttt{/etc/tomcat8/catalina.properties} die Zeile, die mit
\texttt{tomcat.util.scan.StandardJarScanFilter.jarsToSkip} beginnt, und
fügen als neue Zeile darunter \texttt{javassist-*.jar,\textbackslash} ein.
