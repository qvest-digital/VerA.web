...
sudo mkdir -p /var/lib/tomcat8/lib
...
\texttt{/var/lib/tomcat8/webapps/veraweb/OCTOPUS/config\_*.xml}
...
Außerdem müssen Sie, wie im folgenden Unterabschnitt beschrieben,
noch das PostgreSQL-JDBC verlinken.

Schließlich müssen die WARs nach \texttt{/var/lib/tomcat8/webapps/}
