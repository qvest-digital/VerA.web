...
curl -o osiam-resource-server.war https://github.com/osiam/osiam/releases/download/v〈\lstdumpesc{vwiaversosiam}〉/resource-server-〈\lstdumpesc{vwiaversosiam}〉.war
